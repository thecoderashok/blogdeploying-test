...
export function getSortedPostsData() {
  ...
  const allPostsData = designFilesData.concat(productivityFilesData).concat(neckPainFilesData);
...
export function getAllPostIds() {
  ...
  const fileNames = designFileNames.concat(productivityFileNames).concat(neckPainFileNames);
