...
const lowBackPainDirectory = path.join(process.cwd(), 'posts/engineering')


const chronicPainCategory = 'design';
const lowBackPainCategory = 'engineering';
...
export function getSortedPostsData() {
  ...
  const allPostsData = chronicPainFilesData.concat(lowBackPainFilesData);
...
export function getAllPostIds() {
  ...
  const fileNames = chronicPainFileNames.concat(lowBackPainFileNames);
